...
import { FORGOT_PASS_URL, RESET_PASS_URL, USER_INSERT_URL, VERIFY_OTP_URL, FETCH_DEALER_DETAILS_URL, UPDATE_DEALER_DETAILS_URL, FETCH_USER_DETAILS_URL } from '../constants';
